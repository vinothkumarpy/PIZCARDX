...
icon = Image.open(r"D:\vs_code\pizcardx\icon.png")
st.set_page_config(
    page_title="BizCardX: Extracting Business Card Data with OCR | By VINOTH KUMAR",
    page_icon=icon,
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={'About': """# This OCR app is created by *VINOTH KUMAR*!"""}
)
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
        background: url("https://cutewallpaper.org/21x/hianxltb9/Abstract-space-background-geometry-surfaces-lines-and-points-Abstract-tunnel-grid-Abstract-Particles-Background-Camera-flying-through-the-abstract-spiral-twisted-particle-background.jpg");
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"],
                       ...
                       styles={
                           "nav-link": {"font-size": "35px", "text-align": "centre", "margin": "0px", "--hover-color": "#6495ED"},
                           "icon": {"font-size": "35px"},
...
if selected == "Home":
    ...
    with col2:
         st.image(r"D:\vs_code\pizcardx\home.png")    
